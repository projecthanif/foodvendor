    ...
    echo "
          ...
          <!-- #Navigation ends here -->
           ...
           <div class='container p-2'>
               <div class='row'>
                <div class='col-sm-4'>";
    echo "<i class='fa fa-4X'>Hello! " . $_SESSION['name'] . "</i>";
    $name = strtoupper($_SESSION['name']);
    $lname = strtoupper($_SESSION['lname']);

    echo " <ul class='list-group p-2'>
                        <li class='list-group-item active'><a href='account.php' class='list-link text-black ' style='text-decoration:none'><b>ACCOUNT DETAILS</b></a></li>
                        <li class='list-group-item'><a href='order.php' class='list-link text-black ' style='text-decoration:none'><b>ORDERS</b></a></li>
                        <li class='list-group-item'><a href='address.php' class='list-link text-black ' style='text-decoration:none'><b>ADDRESS</b></a></li>
                    </ul>
                </div>
   ";
